                            ...
                            <div class="w-100">
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <form class="mt-4 pt-2" action="{{ route('client.register.submit') }}"  method="post">
                                        ...
                                        <div class="mt-4 pt-2 text-center">
                                            <div class="signin-other-title">
                                                <h5 class="font-size-14 mb-3 text-muted fw-medium">- Register in with -</h5>
                                            </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Illia   . Crafted with <i class="mdi mdi-heart text-danger"></i> by Illia</p>
                                    </div>
                                </div>
                            </div>
                        </div>
