                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="group_name" class="form-select">
                                                    ...
                                                    <option value="Category"
                                                        ...
                                                        Category</option>
                                                    <option value="City"
                                                        {{ $permission->group_name == 'City' ? 'selected' : '' }}>
                                                        City</option>
                                                    <option value="Product"
                                                        {{ $permission->group_name == 'Product' ? 'selected' : '' }}>
                                                        Product</option>
                                                    <option value="Restaraunt"
                                                        {{ $permission->group_name == 'Restaraunt' ? 'selected' : '' }}>
                                                        Restaraunt</option>
                                                    <option value="Banner"
                                                        {{ $permission->group_name == 'Banner' ? 'selected' : '' }}>
                                                        Banner</option>
                                                    <option value="Order"
                                                        {{ $permission->group_name == 'Order' ? 'selected' : '' }}>
                                                        Order</option>
                                                    <option value="Reports"
                                                        {{ $permission->group_name == 'Reports' ? 'selected' : '' }}>
                                                        Reports</option>
                                                    <option value="Review"
                                                        {{ $permission->group_name == 'Review' ? 'selected' : '' }}>
                                                        Review</option>
                                                </select>
                                            </div>
