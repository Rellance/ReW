...
<header id="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex">
            ...
            @php
                $notificationCount = Auth::guard('admin')->user()->unreadNotifications->count();
            @endphp
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div class="p-3">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <a href="#!" class="small text-reset text-decoration-underline"> Unread ({{$notificationCount}})</a>
                            </div>
                        </div>
                    </div>
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="{{route('pending.order')}}" class="text-reset notification-item">
                            <div class="d-flex {{ $notification->read_at ? 'notification-read' : 'notification-unread'}} " onclick="markNotificationAsRead('{{ $notification->id }}')">
