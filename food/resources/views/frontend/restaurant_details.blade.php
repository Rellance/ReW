                        ...
                        <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="mall-category-item">
                                                    <a href="#">
                                                        ...
                                                        @if ($populer->discount_price == null)
                                                            ${{ $populer->price }}
                                                        @else
                                                            <span class="text-danger"><del>${{ $populer->price }}</del>
                                                                ${{ $populer->discount_price }}</span>
                                                        @endif
                                                            ...
                                                            <div class="media-body">
                                                                ...
                                                                <p class="text-gray mb-0">
                                                                    @if ($product->discount_price)
                                                                        <span
                                                                            class="text-danger"><del>${{ $product->price }}</del></span>
                                ...
                                <div id="gallery" class="bg-white rounded shadow-sm p-4 mb-4">
                                    <div class="restaurant-slider-main position-relative homepage-great-deals-carousel">
                                        ...
                                        <div class="position-absolute restaurant-slider-view-all"><button type="button"
                                                class="btn btn-light bg-white">See all Photos</button></div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="address-map float-right ml-5">
                                        <div class="mapouter">
                                            <div class="gmap_canvas"><iframe
                                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4649.364301680314!2d24.944690277167673!3d60.16696907503074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46920bcecb53b045%3A0xd80411aa06b8ccbe!2sEtel%C3%A4esplanadi%2014%2C%2000130%20Helsinki!5e1!3m2!1sen!2sfi!4v1743666008028!5m2!1sen!2sfi"
                            ...
                            <div class="tab-pane fade" id="pills-reviews" role="tabpanel"
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-4 clearfix graph-star-rating">
                                    ...
                                    <div class="graph-star-rating-header">
                                        <div class="star-rating">
                                            @for ($i = 1; $i < 5; $i++)
                                                <a href="#"><i class="icofont-ui-rating {{ $i <= round($averageRating) ? 'active' : '' }}"></i></a>
                                            @endfor
                                            <b class="text-black ml-2">{{ $totalReviews }}</b>
                                        </div>
                                        <p class="text-black mb-4 mt-2">Rated {{ $averageRating }} out of 5</p>
                                    </div>
                                    <div class="graph-star-rating-body">
                                        ...
                                        <div class="rating-list">
                                            ...
                                            <div class="rating-list-right text-black">{{($ratingPercentages[$star])}}%</div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
                                    @guest
                                        <h5 class="mb-4">Login to Leave Comment</h5>
                                        <p class="mb-3">Please login to leave a comment.</p>
                        ...
                        <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                                ...
                                @if (session('cart'))
                                    @foreach (session('cart') as $id => $details)
                                        ...
                                        <div class="gold-members p-2 border-bottom">
                                            <p class="text-gray mb-0 float-right ml-2">${{ number_format($itemTotal, 2) }}
                                            </p>
                            ...
                            @if (Session::has('coupon'))
                                <div class="mb-2 bg-white rounded p-2 clearfix">
                                    ...
                                    <p class="mb-1">Total Discount <span class="text-info" data-toggle="tooltip"
                                    ...
                                    <div class="input-group input-group-sm mb-2">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn btn-primary" type="submit" id="button-addon2"><i
                                                    class="icofont-sale-discount" onclick="ApplyCoupon()"></i>
                                                APPLY</button>
                                        </div>
                                    </div>
                                </div>
