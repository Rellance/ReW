                        ...
                        <div class="item pb-3">
                            <div class="list-card bg-white h-100 rounded overflow-hidden position-relative shadow-sm">
                                <div class="list-card-image">
                                    ...
                                    <a href="detail.html">
                                        <img src="{{ asset('upload/client_images/'.$item->photo) }}" class="img-fluid item-img" style="width: 300px; height: 250px;">
                                    </a>
                                </div>
                                <div class="p-3 position-relative">
                                    <div class="list-card-body">
                                        <h6 class="mb-1"><a href="detail.html" class="text-black">{{ $item->name }}</a>
                                        </h6>
