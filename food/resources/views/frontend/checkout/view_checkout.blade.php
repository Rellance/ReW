...
<div class="tab-pane fade show active" id="v-pills-cash" role="tabpanel" aria-labelledby="v-pills-cash-tab">
    ...
    <form action="{{ route('cash_order') }}" method="post">
        ...
        <input type="hidden" name="address" value="{{ Auth::user()->addres }}">
...
<div class="tab-pane fade" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
 ...
 <br>
             ...
             <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                <div class="d-flex mb-4 osahan-cart-item-profile">
                   ...
                   <div class="d-flex flex-column">
                      ...
                      <p class="mb-0 text-white"><i class="icofont-location-pin"></i> {{ $profileData->addres }}</p>
                   </div>
                </div>
   ...
   @endif
        ...
        <a href="{{ route('frontend.checkout.thanks') }}" class="btn btn-success btn-block btn-lg">PAY  
            @if (Session::has('coupon'))
            ${{ $total - Session()->get('coupon')['discount_amount'] }}
            @else
            ${{ $total }}
...
<script type="text/javascript">
   ...
   var stripe = Stripe('pk_test_51RR5s3Fk24PkRvuC1eiAj0OQwRJaFbdzwCkQAVvhYo1XBJxsTv9jJ6e7hue1HokgOa0dmLUCKylFKKhh744YT3Vu00IeC4hXvC');
